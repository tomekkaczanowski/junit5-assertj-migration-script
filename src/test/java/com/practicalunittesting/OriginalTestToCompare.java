...
public class JUnit5AssertionsTest {
    ...
    public void nullNotNull() {
        ...
        JUnitAssertionsTest.MyClass completelyNull = null;
    ...
    @Test
    public void same() {
        JUnitAssertionsTest.MyClass myObject = new JUnitAssertionsTest.MyClass();
        JUnitAssertionsTest.MyClass otherObject = new JUnitAssertionsTest.MyClass();
    ...
    void fails() {
        Assertions.fail();
        Assertions.fail("ouch!");
        Assertions.fail("ouch!", new Throwable());
